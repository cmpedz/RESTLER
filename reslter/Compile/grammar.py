...
request = requests.Request([
    ...
    primitives.restler_static_string(""",
    "role":"""),
    primitives.restler_fuzzable_group("role", ['admin','user','premium']  ,quoted=True),
    primitives.restler_static_string("}"),
    primitives.restler_static_string("\r\n"),
...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "username":"""),
    primitives.restler_fuzzable_group("username", ['lehienadmin']  ,quoted=True),
    primitives.restler_static_string(""",
    "password":"""),
    primitives.restler_fuzzable_group("password", ['12345678']  ,quoted=True),
    primitives.restler_static_string("}"),
    primitives.restler_static_string("\r\n"),
